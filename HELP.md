...
* The original package name 'ca.bc.gov.nrs.sb-reactive' is invalid and this project uses 'ca.bc.gov.nrs.sbreactive' instead.
...
```
$ docker run --rm sb-reactive:0.0.1-SNAPSHOT
```
